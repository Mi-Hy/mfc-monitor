...
def ep_change_resistance(value):
    ...
    print('Changing resistance to:', value)
    ...
    # # even wachten tot er data terugkomt
    # time.sleep(1)

    # # lees max 100 bytes
    # rx_data = ser.read(300)

    # if rx_data:
    #     print("RX data (hex):", rx_data.hex(" "))
    #     print("RX data (ascii):", rx_data.decode(errors="replace"))
    # else:
